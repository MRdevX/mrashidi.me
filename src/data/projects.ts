...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "A cyberpunk-inspired personal website and portfolio showcasing my work as a Software Engineer. Built with Next.js, TypeScript, and Tailwind CSS, featuring an interactive terminal, real-time GitHub activity tracking, and blog integration.",
    highlights: [
