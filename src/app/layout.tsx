...
export const metadata: Metadata = {
  title: "Dee M. Rashidi | Full Stack Developer",
  description: "Expert Full Stack Developer specializing in React, Node.js, and modern web technologies. View my portfolio, projects, and get in touch for collaborations.",
  keywords: "full stack developer, web developer, react developer, node.js, javascript, portfolio, software engineer",
  creator: "Dee M. Rashidi",
  authors: [{ name: "Dee M. Rashidi", url: "https://mrashidi.me" }],
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://mrashidi.me",
    siteName: "Dee M. Rashidi - Full Stack Developer",
    title: "Dee M. Rashidi | Full Stack Developer",
    description: "Expert Full Stack Developer specializing in React, Node.js, and modern web technologies.",
    images: [
      {
        url: "https://mrashidi.me/og-image.jpg", // Replace with actual image
        width: 1200,
        height: 630,
        alt: "Dee M. Rashidi - Full Stack Developer",
      },
    ],
  },
  twitter: {
        ...
        <footer className="mt-20 py-8 relative z-10" role="contentinfo" aria-label="Site Footer">
          <div className="max-w-4xl mx-auto px-4">
            <div className="glass-card p-8 text-center">
              <p className="text-gray-400 mb-4">© {new Date().getFullYear()} Dee M. Rashidi. All rights reserved.</p>
              <div className="flex justify-center space-x-6" aria-label="Social Media Links">
                <a
                  ...
                  aria-label="Visit Dee M. Rashidi's GitHub Profile"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="social-link focus-visible:outline-offset-4 focus-visible:outline-orange-500"
                  aria-label="Visit Dee M. Rashidi's LinkedIn Profile"
                >
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a 
                  ...
                  className="social-link focus-visible:outline-offset-4 focus-visible:outline-orange-500" 
                  aria-label="Email Dee M. Rashidi"
                >
