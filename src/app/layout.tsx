  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body className={`${inter.className} bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen`}>
        ...
        <footer className="mt-20 py-8 bg-gray-50 dark:bg-gray-800">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <div className="mt-4 flex justify-center space-x-6">
              ...
              <a href="mailto:m8rashidi@gmail.com" className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
