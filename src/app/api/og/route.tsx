...
export async function GET(request: NextRequest) {
  try {
    ...
    const title = searchParams.get("title") || "Mahdi Rashidi";
    const subtitle = searchParams.get("subtitle") || "Software Backend Engineer";
    const description = searchParams.get("description") || "Building reliable and maintainable systems";
