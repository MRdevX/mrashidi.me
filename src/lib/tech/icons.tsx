...
const ICON_DEFINITIONS: Record<string, { Icon: IconType | React.FC<{ className?: string }>; colorClass: string }> = {
  ...
  nuxt: { Icon: SiNuxt, colorClass: "text-emerald-400" },
  nuxtdotjs: { Icon: SiNuxt, colorClass: "text-emerald-400" },
  nuxtjs: { Icon: SiNuxt, colorClass: "text-emerald-400" },
  flutter: { Icon: SiFlutter, colorClass: "text-sky-400" },
  dart: { Icon: SiDart, colorClass: "text-sky-500" },
  ...
  awslambda: { Icon: FaAws, colorClass: "text-orange-500" },
  serverless: { Icon: FaAws, colorClass: "text-orange-500" },
  awsfargate: { Icon: FaAws, colorClass: "text-orange-500" },
  awsecs: { Icon: FaAws, colorClass: "text-blue-500" },
  ...
  amazonapigateway: { Icon: FaAws, colorClass: "text-yellow-700" },
  apigateway: { Icon: FaAws, colorClass: "text-orange-500" },
  amazoncloudwatch: { Icon: FaAws, colorClass: "text-purple-700" },

  graphql: { Icon: SiGraphql, colorClass: "text-pink-500" },
  restfulapis: { Icon: TbApi, colorClass: "text-blue-500" },
