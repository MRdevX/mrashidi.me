...
function getFooter(templateConfig: ITemplateConfig, showSocialLinks: boolean = true): string {
...
export function render(data: IBaseTemplateData): string {
          ...
          <tr>
            <td align="center" style="padding: 20px 0;">
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="background-color: #1e1e1e; border-radius: 8px; border: 1px solid #333333; box-shadow: 0 4px 16px rgba(0,0,0,0.5);">
                ...
                ${getFooter(templateConfig, showSocialLinks)}
              </table>
            </td>
          </tr>
        </table>
...
export function getDividerElement(): string {
  return getDivider();
}
